...
from flask import Flask , render_template , request , jsonify,predict
...
def review():
    ...
    # example : Positive , ./static/assets/emoticons/positive.png
        ...
        path= predict("./static/assets/emoticons/positive.png/")
        path2 = predict("./static/assets/emoticons/negative/png")

        path , path2 = sa.predict(review)
